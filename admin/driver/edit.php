...
<?php
  ...
  if (isset($_GET['driver_id'])) {
    ...
    $sql = "SELECT * FROM drivers WHERE driver_id = '$edit'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    if (empty($errors)) {
        // Update the database
        $sql = "UPDATE drivers SET first_name = '$first_name', last_name = '$last_name', address = '$address', city = '$city', pincode = '$pincode',
        license_no = '$license_no', mobile_no = '$mobile_no', alternate_no = '$alternate_no', status = '$status' WHERE driver_id = '$edit'";
             ...
             <div class="container-fluid">
                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <form action="edit.php?driver_id=<?php echo $edit; ?>" method="POST">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="pincode" class = "form-control" name="pincode" value="<?php echo $pincode ?>">
                                    <?php if (isset($errors['pincode'])) echo "<span class='error'>* " . $errors['pincode'] . "</span>"; ?>
                                </div>

                                <div class="form-group">
                                    <label for="license_no">License Number:</label>
                                    <input type="text" id="license_no" class = "form-control" name="license_no" value="<?php echo $license_no ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="alternate_no" class = "form-control" name="alternate_no" value="<?php echo $alternate_no?>" >

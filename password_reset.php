<?php include('vendor/inc/config.php'); 
...
if(!isset($error)){
    ...
    $resultresetpass= mysqli_query($mysqli, "UPDATE users SET password='$password' WHERE email='$emailtok'"); 
    if($resultresetpass) 
    { 
           $success="<div class='successmsg'><span style='font-size:100px;'>&#9989;</span> <br> Your password has been updated successfully.. <br> <a href='login.php' style='color:#000;'>Login here... </a> </div>";

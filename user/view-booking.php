             ...
             <div class="container-fluid">
                ...
                ?>
                                     ...
                                     <tr>
                                         ...
                                         <td><?php if($row->status == "Cancel"){ echo '<span class = "badge badge-danger">'.$row->status.'</span>'; } elseif($row->status == "Process"){ echo '<span class = "badge badge-warning">'.$row->status.'</span>'; } else { echo '<span class = "badge badge-success">'.$row->status.'</span>';}?></td>
                                     </tr>

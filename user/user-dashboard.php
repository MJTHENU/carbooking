                 ...
                 <div class="row">
                     ...
                     <div class="col-xl-3 col-sm-6 mb-3">
                         <div class="card text-white bg-warning o-hidden h-100">
                             ...
                             <a class="card-footer text-white clearfix small z-1" href="view-booking.php">
                         ...
                         <div class="table-responsive">
                             <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                 ...
                                 <tbody>
                                    ...
                                    <td><?php if($status == "Available"){ echo '<span class = "badge badge-success">'.$status.'</span>'; } else { echo '<span class = "badge badge-danger">'.$status.'</span>';}?></td>
